...
app.controller('ActivateUserController', [ '$scope', '$resource', '$http', 'User' , function($scope, $resource, $http, User) {
...
app.controller('AdminOrganizationController', [ '$scope', '$http', function($scope, $http) {    
  $scope.submitForm = function(){
    var data = angular.toJson($scope.formData);
    $http.post('/organization', data).
