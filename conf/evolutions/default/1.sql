...
create table "FILE" ("ID" VARCHAR(254) NOT NULL PRIMARY KEY,"MODEL_ID" INTEGER NOT NULL,"TYPE" VARCHAR(254) NOT NULL,"TIMESTAMP" TIMESTAMP NOT NULL,"FINISHED" BOOLEAN NOT NULL,"USER_ID" BIGINT NOT NULL);
create table "MODEL" ("ID" SERIAL NOT NULL PRIMARY KEY,"NAME" VARCHAR(254) NOT NULL,"USER_ID" VARCHAR(254) NOT NULL,"DATE" TIMESTAMP NOT NULL,"MATERIAL" VARCHAR(254) NOT NULL,"LOCATION" VARCHAR(254) NOT NULL,"TEXT" TEXT NOT NULL,"TIMESTAMP" TIMESTAMP NOT NULL);
