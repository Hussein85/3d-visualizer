...
create table "MODEL" ("ID" SERIAL NOT NULL PRIMARY KEY,"NAME" VARCHAR(254) NOT NULL,"USER_ID" VARCHAR(254) NOT NULL,"DATE" TIMESTAMP NOT NULL,"MATERIAL" VARCHAR(254) NOT NULL,"LOCATION" VARCHAR(254) NOT NULL,"TEXT" VARCHAR(254) NOT NULL,"PATH_OBJECT" VARCHAR(254),"PATH_TEXTURE" VARCHAR(254),"PATH_THUMBNAIL" VARCHAR(254));
